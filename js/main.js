...
(function() {
  ...
  function draw() {
    ...
    const waves = [
      { a: 20, f: 0.007, s: 0.14, c: 'rgba(99,102,241,0.07)', oy: 0.28 },
      { a: 26, f: 0.011, s: 0.2, c: 'rgba(99,102,241,0.05)', oy: 0.42 },
      { a: 16, f: 0.005, s: 0.11, c: 'rgba(139,92,246,0.06)', oy: 0.52 },
      { a: 22, f: 0.009, s: 0.15, c: 'rgba(3,3,197,0.05)', oy: 0.35 },
    ];
